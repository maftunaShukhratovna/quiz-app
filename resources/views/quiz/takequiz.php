    ...
    <script>
        ...
        async function getQuizItems() {
            ...
            try {
                ...
                document.getElementById('time-taken').innerText = data.quiz.time_limit + ":00";
                quizData = data;
        ...
        async function quiz() {
            ...
            function displayQuestion(question) {
                ...
                document.getElementById('quizTitle').innerText = quizData.quiz.title;
                document.getElementById('quizDescription').innerText = quizData.quiz.description;
                options.innerHTML = '';
            ...
            startBtn.addEventListener('click', () => {
                ...
                startTimer(quizData.quiz.time_limit*60, document.getElementById('timer')); // 20 minutes
            });
