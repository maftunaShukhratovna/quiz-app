<?php require '../resources/views/components/header.php' ?>
    ...
    <script>
        ...
        document.getElementById('addQuestionBtn').addEventListener('click', function () {
            ...
            questionCounter++;
            console.log(questionCounter, "Add ga keldi"); // 1
        ...
        async function setQuiz() {
            ...
            await apiFetch(`/quizzes/${<?php echo $id; ?>}`, {method: 'GET'})
                .then((data) => {
                    titleInput.value = data.quiz.title;
                    descriptionInput.value = data.quiz.description;
                    timeLimitInput.value = data.quiz.time_limit;
    ...
    <script>
        async function updateQuiz() {
            ...
            const {default: apiFetch} = await import('/js/utils/apiFetch.js');
            await apiFetch(`/updatequiz/${<?php echo $id; ?>}`, {
                    method: 'PUT',
